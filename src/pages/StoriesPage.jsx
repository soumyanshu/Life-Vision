...
export default function StoriesPage({ onOpenApply, onOpenDonate }) {
  ...
  const galleryImages = [
    { src: '/gallary/Traloring.png', title: 'Tailoring Vocational Training & Stitching Practice', category: 'training' },
    { src: '/gallary/Traloring1.png', title: 'Garment Sewing & Pattern Cutting Class', category: 'training' },
    { src: '/gallary/trailoring.jpg', title: 'Industrial Machine Stitching Workshop', category: 'training' },
    { src: '/gallary/butician-training.png', title: 'Beautician Skincare & Makeup Hands-on Session', category: 'training' },
    { src: '/gallary/butician-training1.png', title: 'Bridal Styling & Salon Management Training', category: 'training' },
    { src: '/gallary/beautician2.png', title: 'Beauty Care & Facial Technique Demonstration', category: 'training' },
    { src: '/gallary/beautician3.png', title: 'Hair Styling & Personal Hygiene Practical Class', category: 'training' },
    { src: '/gallary/class room.jpeg', title: 'Interactive Vocational Classroom Learning', category: 'training' },
    { src: '/gallary/class room1.jpeg', title: 'Trainee Orientation & Batch Discussion', category: 'training' },
    { src: '/gallary/classroom2.jpeg', title: 'Theory & Skill Building Classroom Session', category: 'training' },
    { src: '/gallary/seminar.jpeg', title: 'Community Career Seminar & Livelihood Drive', category: 'stories' },
    { src: '/gallary/Group.png', title: 'Trainees Group Graduation & Celebration', category: 'stories' },
    { src: '/gallary/agriculture.jpg', title: 'Organic Farming & Agriculture Skill Drive', category: 'training' },
    { src: '/gallary/agriculture1.png', title: 'Rural Agriculture & Micro-Farmer Workshop', category: 'training' },
    { src: '/gallary/healthcare.png', title: 'Community Healthcare & Caregiving Class', category: 'health' },
    { src: '/gallary/food&beverages.jpeg', title: 'Food & Beverage Catering Workshop', category: 'training' },
    { src: '/gallary/house keeping.jpg', title: 'Hospitality & Housekeeping Practical Training', category: 'training' }
  ];
