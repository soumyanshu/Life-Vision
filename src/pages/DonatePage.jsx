            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-pink-100 shadow-sm space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 text-sm sm:text-base text-slate-800 font-medium leading-relaxed">
                  ...
                  <p><span className="font-bold text-slate-900">Ac. No -</span> 50200015341070</p>
                  <p><span className="font-bold text-slate-900">Bank -</span> HDFC Bank</p>
                  <p><span className="font-bold text-slate-900">Branch -</span> Gurgaon</p>
                  <p><span className="font-bold text-slate-900">IFSC -</span> HDFC0002524</p>
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-slate-200 space-y-2">
                ...
                <p className="text-xs sm:text-sm text-slate-600 font-medium leading-relaxed">
                  After transferring funds, kindly email your payment screenshot and PAN to <a href="mailto:info.lifevision@gmail.com" className="font-bold text-[#C52B75] hover:underline">info.lifevision@gmail.com</a> for your 80G tax receipt.
                </p>
              </div>
