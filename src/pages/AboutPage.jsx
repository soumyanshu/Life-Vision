...
export default function AboutPage({ onOpenApply, onOpenDonate, onOpenCsr, onOpenCollab, navigateTo }) {
  ...
  const leadershipTeam = [
    ...
    },
    {
      ...
      bio: 'Manages strategic NGO initiatives, multi-district project expansion, curriculum standards, and stakeholder collaboration. Soumya ensures every vocational course delivers hands-on, market-relevant training to beneficiaries.',
      quote: 'Real empowerment happens on the ground when practical skills meet opportunity. We are committed to building sustainable pathways to long-term livelihoods.',
      linkedin: 'https://linkedin.com',
      email: 'programs@lifevisionsociety.org'
    }
  ];
    ...
    <div className="bg-[#FFF7F6] min-h-screen py-10 animate-fade-in font-sans space-y-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <section id="leadership" className="scroll-mt-28 bg-white rounded-3xl p-6 sm:p-10 shadow-md border border-purple-100 space-y-8 font-sans">
          ...
          {/* 4 Leadership Circle Members Grid (Clean layout: Circle, Name, Designation & Social Media) */}
